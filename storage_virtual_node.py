...
class StorageVirtualNode:
    ...
    def process_chunk_transfer(
        ...
        # Update metrics
        self.network_utilization += available_bandwidth * 0.1  # Simulate some fluctuation
