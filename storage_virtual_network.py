...
class StorageVirtualNetwork:
    ...
    def get_network_stats(self) -> Dict[str, float]:
        ...
        total_bandwidth = sum(n.bandwidth for n in active_nodes)
        used_bandwidth = sum(n.network_utilization for n in active_nodes)
        total_storage = sum(n.total_storage for n in active_nodes)
        used_storage = sum(n.used_storage for n in active_nodes)
